...
$\large \begin{aligned} Perspective Matrix = \begin{bmatrix} \frac {1} {Aspect \cdot \tan (\frac {Fov} {2})} & 0 & 0 & 0 \\ 0 & \frac {1} {\tan (\frac {Fov} {2})} & 0 & 0 \\ 0 & 0 & \frac {FarZ} {FarZ - NearZ} & 1 \\ 0 & 0 & -\frac {NearZ \cdot FarZ} {FarZ - NearZ} & 0 \end{bmatrix} \end{aligned}$
